<div class="span9">
    <ul class="breadcrumb">
		...
		<li class="active">All  <?php echo $category_name; ?>  Products</li>
    </ul>
    <h3>You Are Showing,All <span style="color:blue;"> <?php echo $category_name; ?> </span>Product <small class="pull-right"> <?php echo $this->welcome_model->all_product_count_by_category_id($category_id); ?> products are available </small></h3>	
	<hr class="soft"/>

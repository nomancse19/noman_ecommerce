                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form role="form" action="<?php echo base_url()?>Save_Manufacture" method="post">
                                        <div class="form-group">
                                            <label>Manufacture Name</label>
                                            <input class="form-control" type="text" name="manufacture_name" required=""/>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Manufacture Short Description</label>
                                            <input class="form-control" type="text" name="manufacture_description" required=""/>
                                        </div>
                                         <div class="form-group">
                                            <label>Publication Status</label>
                                            <select class="form-control" name="manufacture_publication_status" required="">

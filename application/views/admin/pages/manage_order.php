                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                <?php if($all_order_info->bkash_payment_status=='pending'){?>
                                                <a class="btn btn-danger" href="<?php echo base_url()?>Confirm-Payment/<?php echo $all_order_info->order_id;?>">
                                                    <i class="fab fa-paypal"></i>
                                                </a>
                                                <?php }else{ ?>
                                                <a class="btn btn-success" href="<?php echo base_url()?>super_admin/confirm_order/<?php echo $all_order_info->order_id;?>">
